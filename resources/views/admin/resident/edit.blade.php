                    ...
                    <div class="mb-4 row gx-3 gy-2 align-items-center">
                        ...
                        <div class="col-md-4 mt-4">
                            ...
                            <p><select class="form-select form-select-lg" aria-label=".form-select-lg"
                                    ...
                                    <option value="Adult (20-59 yrs old)" name="classification_by_age">Adult (20-59 yrs
                                        old</option>
                                    <option value="15-49 y.o., not pregnant & non-PP" name="classification_by_age">15-49
                                        y.o., not pregnant & non-PP
                                    </option>
                                    ...
                                    <option value="Infant (29 days - 11 month old)" name="classification_by_age">Infant
                                        (29 days - 11 month old
                                    </option>
                                    <option value="Under 5 (0-59 months)" name="classification_by_age">Under 5 (0-59
                                        months</option>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <p><select class="form-select form-select-lg" aria-label=".form-select-lg" name="education"
                                    ...
                                    <option value="Junior High School Level" name="education">Junior High School Level
                                    </option>
                                    <option value="Junior High School Graduate" name="education">Junior High School
                                        Graduate</option>
                                    <option value="Senior High School Level" name="education">Senior High School Level
                                    </option>
                                    <option value="Senior High School Graduate" name="education">Senior High School
                                        Graduate</option>
                        ...
                        <div class="col-md-6 mt-3">
                            ...
                            <p><select class="form-select form-select-lg" aria-label=".form-select-lg" name="occupation"
                                    id="occupation">
                        ...
                        <div class="col-md-4 mb-2 mt-2">
                            ...
                            <input type="text" class="form-control" name="philhealth_number" id="philhealth_number"
                                placeholder="philhealth number" value="{{ $healthInfo->philhealth_number }}">
                        ...
                        <div class="col-md-4 mb-2 mt-2">
                            ...
                            <p><select class="form-select form-select-lg" aria-label=".form-select-lg" name="remark"
                                    ...
                                    <option value="Severe Acute Malnutrition" name="remark">Severe Acute Malnutrition
                                    </option>
                                    <option value="Moderate Acute Malnutrition" name="remark">Moderate Acute Malnutrition
                                    </option>
                        ...
                        <div class="col-md-3 mb-2 mt-3">
                            ...
                            <input type="date" class="form-control" name="last_menstrual_period"
                                value="{{ $womens->last_menstrual_period }}" id="last_menstrual_period">
                        ...
                        <div class="col-md-9 mb-2">
                            ...
                            <input type="text" class="form-control" name="type_of_vegetables" id="type_of_vegetables"
                                placeholder="vegetables planted" value="{{ $backyard->type_of_vegetables }}">
                        ...
                        <div class="col-md-9 mb-2 mt-2">
                            ...
                            <p><select class="form-select form-select-lg" aria-label=".form-select-lg" name="vaccinated"
                                    id="vaccinated">
