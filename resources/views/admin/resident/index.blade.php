...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-3 mb-5">
            <a class="btn btn-primary btn-lg me-md-2" href="{{ route('residents.create') }}">Add Resident</a>
            <a class="btn border-primary btn-lg me-md-2" href="csv">Add CSV file</a>
