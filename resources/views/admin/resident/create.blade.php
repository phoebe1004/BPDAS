                ...
                <div class="bg-light">
                    <div class="mt-3">
                        ...
                        <div class="col-md-2 mt-4">
                            ...
                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg" name="civil_status">
                                <option>--Select--</option>
                        ...
                        <div class="col-md-3 mt-4">
                            ...
                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg" name="services_acquired">
                                <option>--Select--</option>
                                <option value="Immunization" name="services_acquired">Immunization</option>
                                <option value="TB DOTS" name="services_acquired">TB DOTS</option>
                        ...
                        <div class="col-md-3 mt-3">
                            ...
                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg" name="nutritional_status">
                                <option>--Select--</option>
                        ...
                        <div class="col-md-2 mt-4">
                            ...
                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg" name="employment_status">
                                <option>--Select--</option>
                        ...
                        <div class="col-md-2 mt-4">
                            ...
                            <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg" name="pwd_status">
                                <option>--Select--</option>
